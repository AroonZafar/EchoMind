...
export type MemoryNode = { id: string; name: string; type: "Person" | "Task" | "Event"; detail?: string };
export type MemoryEdge = { source: string; target: string };
export type MemoryGraph = { nodes: MemoryNode[]; edges: MemoryEdge[] };

const colors = { Person: "#7aa6ff", Task: "#75d5a0", Event: "#f4ac73" };
