...
"[project]/frontend/app/api/voice-token/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    const tokenServerUrl = process.env.VOICE_TOKEN_SERVER_URL ?? "http://localhost:3001/api/voice-token";
    try {
        const response = await fetch(tokenServerUrl, {
            cache: "no-store"
        });
        const body = await response.text();
        return new __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](body, {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_c3emo._.js.map